							...
							plugins.map((plugin) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											...
											children: [
												...
												plugin.status === "blocked" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													style: styles.conflict,
													children: ["冲突：", plugin.conflicts.join(", ")]
												})
											]
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: {
											...styles.badge,
											...plugin.status === "blocked" ? styles.badgeBlocked : plugin.enabled ? styles.badgeOn : styles.badgeOff
										},
										children: plugin.status === "blocked" ? "已阻断" : plugin.status === "dependency" ? "普通依赖" : plugin.enabled ? "已启用" : "已禁用"
									}),
